  ...
  <div>
    ...
    <v-toolbar flat dense color="transparent" scroll-off-screen>
      ...
      <v-toolbar-title class="headline">
        <span class="font-weight-light">Léo </span>
        <span class="green--text">Teixeira</span>
      </v-toolbar-title>
      <v-spacer></v-spacer>
      ...
      <v-toolbar-items class="hidden-sm-and-down">
        ...
        <v-btn flat to="/competences" active-class="green--text headline">Competences</v-btn>
        <v-btn flat to="/projets" active-class="green--text headline">Projets</v-btn>
