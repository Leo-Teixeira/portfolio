<template>
  <v-container grid-list-xl>
    <h2 class="pl-4">
      <span>Projets </span>
      <span class="green--text">PYTHON</span>
    </h2>
      ...
      >
        <template v-slot:activator="{ on }">
          <v-flex xs12 sm6 md4 lg4 xl4 v-on="on">
            <v-card :to="'/portfolio/'+(image.title).toLowerCase()" hover flat color="transparent">
              <v-img
                :src="image.poster"
                height="230"
                :alt="image.title"
      ...
      images: [
        {
          dialog: false,
          title: "Pygamon",
          poster: require('./../../images/pygamon.png')
        },
        {
          dialog: false,
          title: "Pendu",
          poster: require('./../../images/pendu.jpg')
        },
                {
          dialog: false,
          title: "JustePrix",
          poster: require('./../../images/jeu_juste_prix.jpeg')
        }
      ]
    };
  }
